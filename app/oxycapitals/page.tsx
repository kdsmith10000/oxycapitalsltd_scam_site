        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-3">
            ...
            <p className="text-purple-300 text-sm">
              <strong>Linked Operation:</strong> This domain was taken down on the same day as MirrorExp (mirrorexp.com). Both domains were updated on Feb 7, 2026 and expire within 9 days of each other — strong evidence these are the same scam operation.
            </p>
          </div>
        </div>
      </section>
